...
function AddProducts() {
    ...
    const[yearOfUsed , setYearOfUsed] = useState("");
    // const [ image , setImage] = useState("");

    const addProducts = async (e) => {

            e.preventDefault();
         console.log(productName , MRP , DiscountPrice  , availableQuantity , description , yearOfUsed );
        ...
        <div>
            <div className="sign__up__container" >
                ...
                <form method="POST" className="sign__up__form" >
                    ...
                    name="availableQuantity"
                    value={yearOfUsed}
                    onChange={(e)=>setYearOfUsed(e.target.value)}
                    required >
                    </input>
